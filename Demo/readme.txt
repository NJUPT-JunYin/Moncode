...
2 How to use it.
1) Copy the two files (gf_lookuptable.h and gf_lookuptable.c) in your project, and include them in your project.
...
In the gf_lookuptable.c file, we list some primitive ploynomial.
